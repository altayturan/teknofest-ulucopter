...
baslangic = dk.LocationGlobalRelative(40.2313338,28.8720747,7)
bitis = dk.LocationGlobalRelative(40.2314487,28.8718316,7)
...
cmd1 = dk.Command( 0, 0, 0, mavutil.mavlink.MAV_FRAME_GLOBAL_RELATIVE_ALT, mavutil.mavlink.MAV_CMD_DO_CHANGE_SPEED, 0, 0, 1 #HIZ
                                                                                                                ,2, 0, 0, 0, 0,0)
cmd2 = dk.Command( 0, 0, 0, mavutil.mavlink.MAV_FRAME_GLOBAL_RELATIVE_ALT, mavutil.mavlink.MAV_CMD_NAV_WAYPOINT, 0, 0, 0, 0, 0, 7,bitis.lat,bitis.lon,ucusseviye)
cmd3 = dk.Command( 0, 0, 0, mavutil.mavlink.MAV_FRAME_GLOBAL_RELATIVE_ALT, mavutil.mavlink.MAV_CMD_NAV_WAYPOINT, 0, 0, 0, 0, 0, 7,baslangic.lat,baslangic.lon,ucusseviye)
