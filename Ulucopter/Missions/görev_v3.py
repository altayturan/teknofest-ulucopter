...
from pymavlink.mavwp import HAVE_PROTOBUF
import cv2
import numpy as np
######################### CONNECTION ##########################
...
cmds.wait_ready()
cmds.clear()
cmd1=dk.Command( 0, 0, 0, mavutil.mavlink.MAV_FRAME_GLOBAL_RELATIVE_ALT, mavutil.mavlink.MAV_CMD_NAV_SPLINE_WAYPOINT, 0, 0, 0, 0, 0, 0,-35.36292388,149.16534215,15)
cmd2=dk.Command( 0, 0, 0, mavutil.mavlink.MAV_FRAME_GLOBAL_RELATIVE_ALT, mavutil.mavlink.MAV_CMD_NAV_SPLINE_WAYPOINT, 0, 0, 0, 0, 0, 0,-35.36272587,149.16515331,15)

cmds.add(cmd1)
cmds.add(cmd2)
cmds.upload()

print(iha.parameters)
mode("GUIDED")
arm()
takeoff(15)
while iha.location.global_relative_frame.alt < 15*0.95:
    time.sleep(1)
mode("AUTO")
print(iha.parameters.keys)
time.sleep(15)
mode("RTL")
